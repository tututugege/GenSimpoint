...
#define SDRAM_SIZE 0x10000000u
#define DDR_BASE 0x80000000u
#define PHYSICAL_MEMORY_LENGTH 0x80000000u

#define UART_BASE 0x10000000
#define UART_MMIO_SIZE 0x00000100
#define PLIC_BASE 0x0c000000
#define PLIC_MMIO_SIZE 0x00210000
#define XPS_INTC_BASE 0x1fb00000
#define XPS_INTC_MMIO_SIZE 0x00001000
#define TIMER_BASE 0x1fd0e000
#define TIMER_MMIO_SIZE 0x00000100
#define OCSDC_BASE 0x1fe10000
#define OCSDC_MMIO_SIZE 0x00000100
...
enum enum_number_opcode {
  ...
  number_12_opcode_float = 0b1010011,  // OP-FP (Zfinx scalar fp compute)
